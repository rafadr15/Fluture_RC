...
3. Din interfața PlatformIO se apasă butonul **Upload** (sau se rulează comanda `pio run --target upload` din terminal). Această acțiune compilează codul și îl încarcă pe microcontroler.
